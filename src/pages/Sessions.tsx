...
const ALL_SESSIONS = [
  {
    ...
    speaker: 'Sheikh Fatai Okeola',
    role: "Distinguished Qari'",
    type: 'Recitation',
    location: 'Main Hall',
    also: ['Sheikh Ridwan Jamiu', 'Sheikh Musa Abdulkadir'],
    category: 'Opening',
    ticket: 'All Tickets',
    img: recitersImg,
    desc: "The conference opens with a recitation of the Holy Qur'an by Sheikh Fatai Okeola, followed by a welcome address and opening remarks from the Foundation's leadership.",
    color: '#12522F',
  },
  {
    id: 2,
    time: '11:00 AM',
    duration: '75 min',
    title: "Keynote: The Qur'an as Catalyst for Reform",
    speaker: 'Dr. Malam Abdulwahab Iyanda',
    role: 'Islamic Studies Scholar',
    type: 'Lecture',
    location: 'Main Hall',
    also: ['Prof. Yusuf Omotosho'],
    category: 'Keynote',
    ticket: 'All Tickets',
    img: 'https://images.unsplash.com/photo-1544531586-fde5298cdd40?w=700&h=420&fit=crop&auto=format',
    desc: "The keynote address examines how the Qur'an serves as a timeless guide for the reformation of society — addressing corruption, injustice, and moral decay through its divine wisdom.",
    color: '#B5352A',
  },
  {
    id: 3,
    ...
    speaker: 'Prof. Habeebah Oladosu',
    role: "Scholar — Qur'anic Studies & Reform",
    type: 'Panel',
    location: 'Main Hall',
    also: ['Sheikh Musa Abdulkadir', 'Ustadha Aminat Aliyu', 'Dr. Ibrahim Kawu'],
    category: 'Panel Discussion',
    ticket: 'All Tickets',
    img: panelImg,
    desc: "The IQC 5.0 panel engages the central question: Beyond Recitation: How Can the Qur'an Truly Reform the Ummah? Panelists explore Qur'anic paradigms for reconstructing the intellectual, ethical, spiritual, and societal foundations of the Muslim community.",
    color: '#FFC153',
  },
  {
    id: 4,
    ...
    type: 'Recitation',
    location: 'Main Hall',
    also: ['Guest Reciters', 'Hafiz Ibrahim Yusuf'],
    category: 'Recitation',
    ticket: 'All Tickets',
    img: recitersImg,
    desc: "A dedicated showcase of Qur'anic recitation featuring Sheikh Fatai Okeola and specially invited guest reciters. This session celebrates the beauty, precision, and spiritual depth of tajweed in the recitation of Allah's word.",
    color: '#12522F',
  },
  {
    id: 5,
    time: '3:30 PM',
    duration: '90 min',
    title: "Lecture: The Ethical & Spiritual Foundations of the Ummah",
    speaker: 'Prof. Yusuf Omotosho',
    role: 'Senior Islamic Scholar, UI',
    type: 'Lecture',
    location: 'Main Hall',
    also: ['Sheikh Ridwan Jamiu', 'Ustadha Aminat Aliyu'],
    category: 'Lecture',
    ticket: 'All Tickets',
    img: panelImg,
    desc: "Drawing on classical and contemporary scholarship, this lecture examines the Qur'anic prescription for moral and spiritual reformation — at the individual, family, and community level — with practical applications for the modern Ummah.",
    color: '#16201A',
  },
  {
    id: 6,
